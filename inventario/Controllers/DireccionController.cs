...
namespace inventario.Controllers
{
    public class DireccionController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdDir,Pais,Estado,Ciudad,Colonia,Calle,NumExt,NumInt,CodePostal")] Direccion direccion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdDir,Pais,Estado,Ciudad,Colonia,Calle,NumExt,NumInt,CodePostal")] Direccion direccion)
        {
            if (ModelState.IsValid)
            {
